                        ...
                        <div>
                            ...
                            <div class="totalvalue">
                                <h2>
                                    ...
                                    {{ $transaction_history->sum('amount') }}
                                </h2>
                            </div>
                        </div>
                        <div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <img class="img-30 me-2" src="assets/images/user/1.webp" alt="profile">
                                        Jason Peras
                                    </td>
                                    <td>jasonprass@mail.com</td>
                                    <td>Donation</td>
                                    <td>
                                        <a class="btn greyBtn" href="javascript:;" title="">Canceled</a>
                                    </td>
                                    <td>
                                        <div class="dropmenu">
                                            <a href="javascript:;" title="">
                                ...
                                <tr>
                                    ...
                                    <td>June 1, 2024, 08:22 AM</td>
                                    <td>
                                        <img class="img-30 me-2" src="assets/images/user/2.webp" alt="profile">
                                        Jason Peras
                                    </td>
                                    <td>jasonprass@mail.com</td>
                                    <td>Donation</td>
                                    <td>
                                        <a class="btn redBtn" href="javascript:;" title="">Pending</a>
                                    </td>
                                    <td>
                                        <div class="dropmenu">
                                            <a href="javascript:;" title="">
                                ...
                                <tr>
                                    ...
                                    <td>June 1, 2024, 08:22 AM</td>
                                    <td>
                                        <img class="img-30 me-2" src="assets/images/user/3.webp" alt="profile">
                                        Jason Peras
                                    </td>
                                    <td>jasonprass@mail.com</td>
                                    <td>Donation</td>
                                ...
                                <tr>
                                    ...
                                    <td>June 1, 2024, 08:22 AM</td>
                                    <td>
                                        <img class="img-30 me-2" src="assets/images/user/4.webp" alt="profile">
                                        Jason Peras
                                    </td>
                                    <td>jasonprass@mail.com</td>
                                    <td>Donation</td>
                                ...
                                <tr>
                                    ...
                                    <td>June 1, 2024, 08:22 AM</td>
                                    <td>
                                        <img class="img-30 me-2" src="assets/images/user/5.webp" alt="profile">
                                        Jason Peras
                                    </td>
                                    <td>jasonprass@mail.com</td>
                                    <td>Donation</td>
                                    <td>
                                        <a class="btn greenBtn" href="javascript:;" title="">Pending</a>
                                    </td>
                                    <td>
                                        <div class="dropmenu">
                                            <a href="javascript:;" title="">
