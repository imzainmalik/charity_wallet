                    ...
                    <form action="{{ route('admin.blog.save') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="text" required class="form-control" name="title" placeholder="Blog Title">
                            </div>
                            ...
                            <div class="col-12 py-4">
                                ...
                                <input type="file" name="thumbnail" required class="form-control" style="height: 45px;">
                            </div>
                            <div class="col-12 py-4">
                                <label for="">Blog description</label>
                                <textarea name="editor" class="form-control" id="editor" cols="30" rows="10"><p>This is some sample content.</p></textarea>
                            </div>
